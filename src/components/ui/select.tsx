...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      // Heights live here rather than on each usage: they're written as
      // data-[size=...] variants, which tailwind-merge doesn't treat as
      // conflicting with a plain h-* class, so per-instance overrides were
      // silently losing. Default is 44px to meet the touch-target minimum.
      className={cn(
